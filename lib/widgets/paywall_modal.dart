...
class _PaywallModalState extends State<PaywallModal> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Content on top (scrollable to handle error messages)
          SafeArea(
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildCloseButton(colorScheme, isDark),
                      _buildRestoreButton(accent),
                    ],
                  ),
  ...
  Widget _buildRestoreButton(Color accent) {
    return GestureDetector(
